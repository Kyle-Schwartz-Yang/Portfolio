...
const mainTasks = gulp.series(fonts, gulp.parallel(copy, cmdHtml, cmdScss, cmdJavaScript, cmdSvgSprite, cmdImages));//OR const mainTasks = gulp.parallel(copy, cmdHtml, cmdScss, cmdJavaScript, cmdImages); 
